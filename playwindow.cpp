...
void PlayWindow::setIconToButton(QRightClickButton* button, int minesNum) {
    ...
    if (minesNum == 0) {
        button->setIcon(QIcon(":/icons/icons/empty_cell.png"));
    } else if (minesNum == 1) {
        button->setIcon(QIcon(":/icons/icons/digit_1.png"));
    } else if (minesNum == 2) {
        button->setIcon(QIcon(":/icons/icons/digit_2.png"));
    } else if (minesNum == 3) {
        button->setIcon(QIcon(":/icons/icons/digit_3.png"));
    } else if (minesNum == 4) {
        button->setIcon(QIcon(":/icons/icons/digit_4.png"));
    } else if (minesNum == 5) {
        button->setIcon(QIcon(":/icons/icons/digit_5.png"));
    } else if (minesNum == 6) {
        button->setIcon(QIcon(":/icons/icons/digit_6.png"));
    } else if (minesNum == 7) {
        button->setIcon(QIcon(":/icons/icons/digit_7.png"));
    } else if (minesNum == 8) {
        button->setIcon(QIcon(":/icons/icons/digit_8.png"));
    } else if (minesNum == -1) {
        button->setIcon(QIcon(":/icons/icons/flag.png"));
    } else if (minesNum == -2) {
        button->setIcon(QIcon());
    } else if(minesNum == -3) {
        button->setIcon(QIcon(":/icons/icons/mine_clicked.png"));
    }
...
void PlayWindow::addResult(QString name)
{
    ...
    dbManager.insertRecord(name, currentDifficult, secondsAfterStart);
}
